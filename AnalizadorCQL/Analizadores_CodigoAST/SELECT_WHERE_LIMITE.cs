...
{
    public class SELECT_WHERE_LIMITE : NodoAbstracto
    {
        public SELECT_WHERE_LIMITE(String Nombre) : base(Nombre)
        {
        ...
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion select-where-LIMIT");
        }
