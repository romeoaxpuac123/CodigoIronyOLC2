...
{
    public class COUNT_SELECT_ORDER_BY:NodoAbstracto
    {

        public COUNT_SELECT_ORDER_BY(String Nombre) : base(Nombre)
        {
        ...
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion COUNT-select-ORDER_BYE");
        }
        ...
        public override string Ejecutar(Entorno entorno)
        {
            ...
            if (this.ListaID1.Count == 1 && this.ListaID1[0] == "* (Key symbol)")
            {
               return entorno.MostrarDiccionario2NUmero().ToString();
            }
            else
            {
               // System.Diagnostics.Debug.WriteLine("\n\n\n\nDICCIONARIO-Tabla->\n\n");
                ...
                return entorno.MostrarDiccionario2Numero(this.ListaID1).ToString() ;
            }
