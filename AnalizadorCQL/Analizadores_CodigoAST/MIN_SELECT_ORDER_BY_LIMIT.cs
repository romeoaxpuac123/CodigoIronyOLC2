...
{
    public class MIN_SELECT_ORDER_BY_LIMIT : NodoAbstracto
    {
        public MIN_SELECT_ORDER_BY_LIMIT(String Nombre) : base(Nombre)
        {
        ...
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion MIN SELECT_ORDER_BY_LIMIT");
        }
        ...
        public override string Ejecutar(Entorno entorno)
        {
            ...
            List<String> lISTA1 = entorno.MostrarDiccionario2P(this.ListaID1, ellimite);
            lISTA1.Sort();
