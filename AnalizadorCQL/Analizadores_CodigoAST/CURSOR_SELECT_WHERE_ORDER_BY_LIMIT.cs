...
{
    public class CURSOR_SELECT_WHERE_ORDER_BY_LIMIT : NodoAbstracto
    {
        public CURSOR_SELECT_WHERE_ORDER_BY_LIMIT(String Nombre) : base(Nombre)
        {
        ...
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion CURSOR- SELECT_WHERE_ORDER_BYT MIT");
        }

        public override string Ejecutar(Entorno entorno)
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion CURSOR- SELECT_WHERE_ORDER_BYT IMIT");
            ...
            return "CURSOR-SELECT-WHERE-ORDERR-BY-LIMIT";
        }
    }
}