...
{
    public class CURSOR_SELECT_LIMIT : NodoAbstracto
    {
        public CURSOR_SELECT_LIMIT(String Nombre) : base(Nombre)
        {
        }

        public override void Ejecutar()
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion CURSOR-SELECT-LIMIT");
        }
        ...
        public override string Ejecutar(Entorno entorno)
        {
            ...
            if (this.ListaID1.Count == 1 && this.ListaID1[0] == "* (Key symbol)")
            {
                ...
                entorno.MostrarCampos2LimiteArchivo(Tabla, BD, Int32.Parse(ElLimite),entorno.CursorEnUso());
            ...
            entorno.MostrarCamposExactosLimiteArchivo(Tabla, BD, CamposAMostrar, Int32.Parse(ElLimite),entorno.CursorEnUso());

            return "CURSOR-SELECT-LIMIT";
        }
    }
}