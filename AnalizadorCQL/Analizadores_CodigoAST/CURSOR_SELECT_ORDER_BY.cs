...
{
    public class CURSOR_SELECT_ORDER_BY : NodoAbstracto
    {
        public CURSOR_SELECT_ORDER_BY(String Nombre) : base(Nombre)
        {
        ...
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion CURSOR-select-ORDER_BYE");
        }
        ...
        public override string Ejecutar(Entorno entorno)
        {
            ...
            if (this.ListaID1.Count == 1 && this.ListaID1[0] == "* (Key symbol)")
            {
                entorno.MostrarDiccionario2Archivo(entorno.CursorEnUso());
            }
            else
            {
                ...
                entorno.MostrarDiccionario2Archivo(this.ListaID1,entorno.CursorEnUso());
            }
            return "cursor-selec-order-by";
        }
    }
}