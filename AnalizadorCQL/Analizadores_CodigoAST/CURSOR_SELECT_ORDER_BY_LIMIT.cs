...
{
    public class CURSOR_SELECT_ORDER_BY_LIMIT : NodoAbstracto
    {
        public CURSOR_SELECT_ORDER_BY_LIMIT(String Nombre) : base(Nombre)
        {
        ...
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion CURSOR-SELECT_ORDER_BY_LIMIT");
        }
        ...
        public override string Ejecutar(Entorno entorno)
        {
            ...
            if (this.ListaID1.Count == 1 && this.ListaID1[0] == "* (Key symbol)")
            {
                entorno.MostrarDiccionario2Archivo(ellimite,entorno.CursorEnUso());
            }
            else
            {
                ...
                entorno.MostrarDiccionario2Archivo(this.ListaID1, ellimite,entorno.CursorEnUso());
            }

            return "CURSOR-SELEC-ORDER-BY-LIMIT";
        }
    }
}