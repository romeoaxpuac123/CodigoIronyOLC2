...
{
    public class COUNT_SELECT_WHERE_ORDER_BY:NodoAbstracto
    {
        public COUNT_SELECT_WHERE_ORDER_BY(String Nombre) : base(Nombre)
        {
        ...
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion Counter SELECT_WHERE_ORDER_BYT");
        }
