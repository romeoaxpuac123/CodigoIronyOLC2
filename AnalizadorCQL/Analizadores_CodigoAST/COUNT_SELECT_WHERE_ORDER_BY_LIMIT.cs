...
{
    public class COUNT_SELECT_WHERE_ORDER_BY_LIMIT : NodoAbstracto
    {
        public COUNT_SELECT_WHERE_ORDER_BY_LIMIT(String Nombre) : base(Nombre)
        {

        }
        public override void Ejecutar()
        {
            System.Diagnostics.Debug.WriteLine("Ejecucion COUNT SELECT_WHERE_ORDER_BYT");
        }
